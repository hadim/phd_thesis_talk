...
},{"pBGvAp":190}],192:[function(require,module,exports){
/*!
 * reveal.js
...
var _jsDataSrcSvg = require('./js/data-src-svg');

var _jsDataSrcSvg2 = _interopRequireDefault(_jsDataSrcSvg);

var _jsPrintCss = require('./js/print-css');

var _jsPrintCss2 = _interopRequireDefault(_jsPrintCss);

var _jsVideoFragment = require('./js/video-fragment');
...
document.addEventListener('DOMContentLoaded', function (event) {
  window.Reveal = _revealJsJsReveal2['default']; // plugins need that
...
function loadDataSrcSVG() {
	...
	var loadSVGs = svgsToLoad.map(function (svg) {
		return fetch(svg.getAttribute('data-src')).then(function (response) {
			...
			if (document.querySelector("article.slides").getAttribute("data-use-svg") != "false") {
...
exports['default'] = loadVideoFragment;

function loadVideoFragment() {
